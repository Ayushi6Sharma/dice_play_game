function diceCheck()
{
    ...
    let image1=`../images/dice${random1}.jpg`;
    let image2=`../images/dice${random2}.jpg`;
    document.getElementById("img1").setAttribute("src",image1);
    document.getElementById("img2").setAttribute("src",image2);
    if(random1>random2)
    {   
        document.getElementById("result1").style.color="pink";
        document.getElementById("result2").style.color="aqua";
    ...
    {   
        document.getElementById("result1").style.color="aqua";
        document.getElementById("result2").style.color="pink";
